// Seeds the "Seniors" life stage page. Safe to re-run — skips if the slug
// already exists.
//
// Usage: APPWRITE_API_KEY=your_key node scripts/seed-seniors-page.mjs
...
const page = {
  title: 'For Seniors',
  slug: 'seniors',
  intro: 'Nutrition needs shift with age. Learn about eating well to support strength, bone health, and overall wellbeing as you get older.'
};
