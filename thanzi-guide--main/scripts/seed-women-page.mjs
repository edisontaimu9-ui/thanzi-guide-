// Seeds the "Women" life stage page. Safe to re-run — skips if the slug
// already exists.
//
// Usage: APPWRITE_API_KEY=your_key node scripts/seed-women-page.mjs
...
const page = {
  title: 'For Women',
  slug: 'women',
  intro: 'Nutrition needs and health topics shift across a woman\'s life, through pregnancy, breastfeeding, and beyond. Find guidance suited to where you are right now.'
};
